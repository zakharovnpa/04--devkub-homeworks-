...
Эта техника позволяет обрабатывать ситуации, когда есть ошибка во внешнем сервисе и эта ошибка не должна влиять на поведение вызывающей системы и мы хотим снизить
нагрузку на сервисы, испытывабщие проблемы
...
### 4Scale Cube
Ось Z - масштабирование через
разделение данных: каждая
запущенная копия сервиса
отвечает за своё подмножество
данных
Горизонтальное
масштабирование
Ось Y - масштабирование
разделением приложения:
функции выделяются в отдельные
сервисы и запускают независимо
друг от друга
Масштабирование
разделением
Ось X - горизонтальное
