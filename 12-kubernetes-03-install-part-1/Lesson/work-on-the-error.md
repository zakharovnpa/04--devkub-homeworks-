...
### 3. Расчет необходимых ресурсов для каждой ноды кластера. 
1. Определение ресурсов для ноды "Worker node-1".

##### Таблица 3. Потребные ресурсы всех систем ноды "Worker node-1"
...
##### Таблица 4. Потребные ресурсы всех систем ноды "Worker node-2"
Система|Кол-во копий|CPU, шт.| ОЗУ, Гб| HDD, Гб
|-|:-:|:-:|:-:|:-:|
БД|1|1|4|20
Кеширование|1|1|4|20
...
##### Таблица 5. Потребные ресурсы всех систем ноды "Worker node-3"
Система|Кол-во копий|CPU, шт.| ОЗУ, Гб| HDD, Гб
|-|:-:|:-:|:-:|:-:|
БД|1|1|4|20
Кеширование|1|1|4|20
...
##### Таблица 11. Распределение ресурсов на ноде "Control node"
Система|Кол-во CPU, шт.|ОЗУ, Гб|Размер HDD, Гб
|-|:-:|:-:|:-:|
