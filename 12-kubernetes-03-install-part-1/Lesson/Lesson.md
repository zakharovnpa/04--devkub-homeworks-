...
2. Составим таблицу необходимых ресурсов для каждой из нод кластера по условию кластера Kubernetes
##### Таблица 2. Минимально необходимые ресурсы для работы кластера
...
3. Расчет дисковых ресурсов для всех рабочих нод
...
##### Таблица 3. Потребные дисковые ресурсы всех рабочих нод
Система|Для 1 ноды, Гб|К, рез|Всего для ноды, Гб|Кол-во нод, шт.|Итого, Гб
|-|-|-|-|-|-|
БД|20|1,5|30|3|90
...
4. Рассчет количества ядер CPU для всех рабочих нод
##### Таблица 4. Количество CPU для всех рабочих нод
Система|Для 1 ноды, шт.|К, рез|Всего для ноды, шт.|Кол-во нод, шт.|Итого, шт.
|-|-|-|-|-|-|
БД|4|1,5|6|3|18
...
5. Рассчет количества ОЗУ ддля всех рабочих нод
##### Таблица 5. Количество ОЗУ для всех рабочих нод
Система|Для 1 ноды, Гб|К, рез|Всего, Гб|Кол-во нод, шт|Итого, Гб
|-|-|-|-|-|-|
БД|4|1,5|6|3|18
