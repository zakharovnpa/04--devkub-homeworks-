...
#### 4. Добавляем служебные ресурсы. Расчет ресурсов для работы хостовой системы

1. Расчет ресурсов хоста
...
### 5. Рассчет итоговых цифр. В результате должно быть указано количество нод и их параметры.

##### Таблица 6. Распределение ресурсов на различных нодах
