## Лекция по теме "12.4 Развертывание кластера на собственных серверах - часть 2"
...
#### Вариант ручной установки с помощью Kubeadm и с использованием Ansible playbook 
...
- 00:59:00 - ответы на вопросы студентов. Почему надо делать кол-во управляющих нод, на которых установлено etcd нечетное кол-во. Смотри материалы по теме "split brain" 
...
- 01:23:50 - !!! в файле `k8s-claster.yml` раскомментируем ключ `supplementary_addresses_in_ssl_keys` и указываем там наш внешний ip адрес нашего сервера с управляющей нодой и тогда выпишется сертификат, с которым можно будет установить kubesprey так как нужно и этим опльзоваться.

[Подсказка](https://devops.stackexchange.com/question/9483/how-can-i-add-an-additional-ip-hostname-to-my-kubernetes-certificate)
