### Неуспешное добавление к манифесту пода специфкации на подключене к PV. Создание запроса PVC. 

Выводы:
- PVC можно осздавать в любое время
- Спецификацю пода можно изменять только при его перезапуске с удаленем.
