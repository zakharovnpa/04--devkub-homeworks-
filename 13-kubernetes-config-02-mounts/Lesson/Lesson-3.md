...
- [Успешное подключение к PV через StorageClass для Deployment в окружении stage с репликацией](/13-kubernetes-config-02-mounts/Labs/labs-mount-stage-pv-ok.md)
